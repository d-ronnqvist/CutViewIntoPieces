...
//    [self.view addSubview:textView];
    ...
    tornView.layer.anchorPoint = CGPointMake(0.5, 0.0);
    tornView.layer.position = CGPointMake(CGRectGetMidX([textView frame]),
    ...
    [imageViews enumerateObjectsUsingBlock:^(id obj, NSUInteger idx, BOOL *stop) {
        ...
        [moveFromAnchor setToValue:[NSValue valueWithCGPoint:CGPointMake(0.5, 1.0)]];
